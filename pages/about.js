        ...
        <>
            <section className="stripe">
                    <div className="stripe__inner container container--aligned container--flexed ">
                        <div>
                            ...
                            <p>Gibbs Laidler have assisted numerous Housing Associations nationwide to ensure the service received from their broker or insurer is of an appropriate standard and fulfils their business needs. To facilitate our clients further, we produce several insurance guides and briefings, ranging from D&amp;O liability to the issues surrounding joint ventures. As well as bespoke insurance and risk services for clients who retain us long term, such as <b>The Guinness Partnership</b>, <b>L&Q</b>, <b>Network Homes</b> and <b>Optivo</b>.</p>
                        </div>
            ...
            <section className="stripe">
                <div className="stripe__inner container text-centered">
                    ...
                    <TeamMemberCards numberShown={6} teamMembers={teamMembers}/>
