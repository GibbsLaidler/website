...
const TestimonialWrapper = () => {
    ...
    const testimonials = [
        ...
        
        {
            ...
            content: 'Network Housing Association initially used Gibbs Laidler to assist with an insurance tender. We have worked with them for the last ten years on a retained basis assisting the group with insurance and risk issues as we grow and develop. Their help with development risks has been particularly beneficial.',
            reviewer: 'Paul Francis',
            companyName: 'Network Housing Association',
